package com.easy.finance.lucene;
...
import com.easy.finance.util.PropertiesUtil;
...
//	private static Directory directory = FSDirectory.open(Paths.get(indexPath));  
	private static Analyzer analyzer = new org.apache.lucene.analysis.core.SimpleAnalyzer();
	...
	public void addIndex(News news){
		 IndexWriter writer = null;  
	        try {  
	    		...
	    		type2.setIndexOptions(org.apache.lucene.index.IndexOptions.DOCS_AND_FREQS_AND_POSITIONS);
